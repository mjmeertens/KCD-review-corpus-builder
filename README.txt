...
'scripts' has all the scripts. I would recommend you read ABOUT.txt, where I motivate some choices. 'data' has the raw scraped review data and the preprocessed files. 'output' contains output files for sentiment analysis.
